...
class Log2 {
public:
    Log2(std::string id, int level=2)
        : m_class(id),
          m_log_level(level)
        {} 
...
public:
    ...
    void printlog(const std::string& prefix, std::string message)
    {
